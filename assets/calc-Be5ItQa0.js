...
(function initAzCalculator() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    metaEl.textContent = `Imax=${I_max.toFixed(2)}A, Uпоч=${U_start.toFixed(2)}V, Nфакт=${N_fact.toFixed(2)}, Nпо масі=${N_by_mass.toFixed(2)}.`;
  });
})();
//# sourceMappingURL=calc-Be5ItQa0.js.map
